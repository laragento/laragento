...
class GuestOrderManager extends AbstractOrderManager
{
    ...
    protected function mapQuoteToOrder($quote)
    {
        ...
        return [
            ...
            "base_to_global_rate" => "0.0000", // ToDo Must become Dynamic
            "base_to_order_rate" => "0.0000", // ToDo Must become Dynamic
            "base_total_qty_ordered" => $quote->items_qty,
            ...
            "customer_note_notify" => "", // ToDo make dynamic
            ...
            "base_subtotal_incl_tax" => $quote->subtotal, // ToDo Tax Calculation
            "base_total_due" => "0.0000", // ToDo Calculate Prices
            "payment_authorization_amount" => "0.0000", // ToDo Calculate Prices
            "shipping_discount_amount" => "0.0000", // ToDo Calculate Prices
            "subtotal_incl_tax" => $quote->subtotal, // ToDo Tax Calculation
            "total_due" => "0.0000", // ToDo Calculate Prices
            "weight" => "0.0000", //ToDo
            ...
            "original_increment_id" => "", //ToDo must become dynamic
            "relation_child_id" => "", //ToDo must become dynamic
            "relation_child_real_id" => "", //ToDo must become dynamic
            "relation_parent_id" => "", //ToDo must become dynamic
            "relation_parent_real_id" => "", //ToDo must become dynamic
            "remote_ip" => "", //ToDo must become dynamic
            "shipping_method" => $quote->shipping->method,
            "store_currency_code" => $quote->store_currency_code,
            "store_name" => $store->name,
            "x_forwarded_for" => "", //ToDo must become dynamic
            "customer_note" => "", //ToDo must become dynamic
            ...
            "paypal_ipn_customer_notified" => null, //ToDo must become dynamic
        ];
    }
