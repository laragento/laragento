...
namespace Laragento\CustomerImportExport\Providers;
...
class CustomerImportExportServiceProvider extends ServiceProvider
{
    ...
    {
        $this->publishes([
            __DIR__.'/../Config/config.php' => config_path('customerimportexport.php'),
        ], 'config');
        $this->mergeConfigFrom(
            __DIR__.'/../Config/config.php', 'customerimportexport'
        );
    }
    ...
    public function registerViews()
    {
        ...
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/modules/customerimportexport';
        }, \Config::get('view.paths')), [$sourcePath]), 'customerimportexport');
    }
    ...
    {
        $langPath = resource_path('lang/modules/customerimportexport');
