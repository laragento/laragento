...
namespace Laragento\Eav\Providers;
...
class EavServiceProvider extends ServiceProvider
{
    ...
    {
        $viewPath = resource_path('views/modules/eav');
        ...
        $this->loadViewsFrom(array_merge(array_map(function ($path) {
            return $path . '/modules/eav';
        }, \Config::get('view.paths')), [$sourcePath]), 'eav');
    }
    ...
    {
        $langPath = resource_path('lang/modules/eav');

        if (is_dir($langPath)) {
            $this->loadTranslationsFrom($langPath, 'eav');
        } else {
            $this->loadTranslationsFrom(__DIR__ .'/../src/resources/lang', 'eav');
        }
    }
