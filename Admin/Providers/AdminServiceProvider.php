...
namespace Laragento\Admin\Providers;
...
class AdminServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->app['config']->set('auth.providers.admins', [
                'driver' => 'eloquent',
                'model' => 'Laragento\Admin\Models\AdminUser',
        ]);

        $this->app['router']->aliasMiddleware('guest','Laragento\Admin\Http\Middleware\AdminRedirectIfAuthenticated');
    }
    ...
    {
        $this->app->bind(Handler::class,
            'Laragento\Admin\Exceptions\AdminHandler');
    }
